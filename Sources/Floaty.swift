...
extension Floaty {
    ...
    func setAccessibilityView() {
        ...
        var traits = accessibilityView.accessibilityTraits.rawValue
        traits |= UIAccessibilityTraits.button.rawValue
        accessibilityView.accessibilityTraits = UIAccessibilityTraits(rawValue: traits)
    }
